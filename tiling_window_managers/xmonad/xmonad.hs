...
main = do
    ...
    xmproc0 <- spawnPipe "xmobar -x 0 /home/durbar/.config/xmobar/xmobarrc0"
...
myStartupHook = do
          ...
          --setWMName "LG3D"
          spawnOnce "exec /usr/bin/trayer --edge bottom --align right --SetDockType true --SetPartialStrut true --expand true --width 15 --transparent true --alpha 0 --tint 0x292d3e --height 19 &"
